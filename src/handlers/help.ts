...
const HELP = "Use the menu to browse listings, submit a property, save a search, or report a concern.\n\nYour saved searches send up to 20 matching listings each day.";
